        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-1 pt-2">Verifique seu e-mail ✉️</h4>
                    <p class="text-start mb-4">
                        Você deve verificar seu endereço de e-mail. Verifique seu e-mail para obter um link de verificação
                    </p>
                    ...
                    <form action="{{ route('verification.send') }}" method="post">
                        ...
                        <button class="btn btn-primary w-100 mb-3"> Reenviar E-mail </button>
                    </form>
