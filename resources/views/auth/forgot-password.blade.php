...
<head>
    ...
    <title>Reset sua Senha - {{ config('app.name') }}</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="/" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold">Gestão House</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Quer resetar sua senha? 🔒</h4>
                        <p class="mb-4">Informe seu e-mail de acesso e receba as instruções no link que enviaremos.</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Inform seu e-mail de acesso" autofocus required/>
