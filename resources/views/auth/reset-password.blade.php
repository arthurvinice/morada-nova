...
<head>
    ...
    <title>Resetar Senha | Gestão {{ config('app.name') }}</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold ms-1">Gestão House</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Reset sua Senha 🔒</h4>
                        ...
                        <form id="formAuthentication" action="{{ route('password.update') }}" method="POST">
                            ...
                            <input readonly type="hidden" name="token" value="{{ request()->route('token') }}">

                            <div class="mb-3">
                                <label for="email" class="form-label">E-mail</label>
                                <input readonly type="text" class="form-control" id="email" name="email" value="{{ $request->email }}"
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100 mb-3">Salvar Nova Senha</button>
